...
$require = array('お名前','フリガナ','電話番号','メールアドレス','お問い合わせ内容');
...
<header>
	<div>
<a href="index.html"><img src="img/fish_top_logo.png" alt="お魚ロゴ"></a>
		<h1>お問い合わせ 確認画面</h1>
		</div>
</header>
...
<p align="center" class="btn"><input type="hidden" name="mail_set" value="confirm_submit">
<input type="hidden" name="httpReferer" value="<?php echo h($_SERVER['HTTP_REFERER']);?>">
<input type="submit" value="　送信する" class="sousin_btn">
<input type="button" value="前画面に戻る" onclick="history.back();" class="return_btn" ></p>
</form>
<?php } ?>
</div><!-- /formWrap -->
<!-- ▲ *********** 送信内容確認部　※編集は自己責任で ************ ▲-->
...
送信ありがとうございました。<br />
送信は正常に完了しました。<br /><br />
<p class="small_text">お問い合わせいただきありがとうございました。<br />
お問い合わせ内容につきましては、近日中にお返事いたします。</p>
<a class="top_a" href="<?php echo $site_top ;?>">トップページへ戻る&raquo;</a>
</div>
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="" target="_blank">- EBAのメールフォーム練習問題 -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
